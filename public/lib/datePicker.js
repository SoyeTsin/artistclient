...
Calendar.prototype.style = function(){
	...
	strStyle += ".calendar {font-size:12px; margin:0;padding:0px;border:1px solid #CCC;}";
	strStyle += ".calendar ul {list-style-type:none; padding:0;vertical-align:middle;}";
	...
	strStyle += ".calendar .month li{float:left;width:24.8%;height:20px;line-height:20px;text-align:center;background-color:#FFF;}";
	strStyle += ".calendar li a{ text-decoration:none; font-size:12px; color:#F35690;display: block;}";
	strStyle += ".calendar li:hover {cursor:pointer;text-decoration:none;background-color:#F35690;color:#FFF}";
	strStyle += ".calendar li:hover a{color:#FFF}";
	strStyle += ".calendar .date li:hover, .calendar .month li:hover{cursor:pointer;color:#FFF; text-decoration:none;background-color:#F35690;}";
	...
	strStyle += ".selectThisYear, .selectThisMonth{text-decoration:none; margin:0px; color:#FFF; font-weight:bold}";
	...
	strStyle += ".calendarTitle{background:#F35690;text-align:center;height:30px;line-height:30px;clear:both;width:100%;}";
	strStyle += ".calendarTitle .mark{text-decoration:none;color:#FFF;font-family:Tahoma;font-size:18px;font-weight:normal;}";
	strStyle += ".today{ background-color:#F35690;color:#FFF !important; }";
	strStyle += ".calendarBottom {text-align:center;height:20px;line-height:20px;clear:both;width:100%;background-color:#F787B0;color:#FFF;}";
